...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_volunteers&task=reports.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
                ...
                <?php else : ?>
                    ...
                    <table class="table" id="itemsList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_VOLUNTEERS_REPORTS_TABLE_CAPTION'); ?>,
                            <span id="orderedBy">
                                ...
                                <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->id ?>">
                                    ...
                                    <th scope="row" class="has-context">
                                        <div>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($canEdit) : ?>
                                                <a href="<?php echo Route::_('index.php?option=com_volunteers&task=report.edit&id=' . (int) $item->id); ?>"
