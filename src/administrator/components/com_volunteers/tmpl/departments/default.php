...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_volunteers&task=departments.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_volunteers&view=departments'); ?>" method="post"
    ...
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <h3>
                        <?php echo count($this->items); ?> departments (matching filters)
                    </h3>
                    <table class="table" id="itemsList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_VOLUNTEERS_DEPARTMENTS_TABLE_CAPTION'); ?>,
                            <span id="orderedBy">
