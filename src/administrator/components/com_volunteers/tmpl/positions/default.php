...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_volunteers&task=positions.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

?>
<form action="<?php echo Route::_('index.php?option=com_volunteers&view=positions'); ?>" method="post" name="adminForm"
    id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    ...
                    <table class="table" id="itemsList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_VOLUNTEERS_POSITIONS_TABLE_CAPTION'); ?>,
                            <span id="orderedBy">
