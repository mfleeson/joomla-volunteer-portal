...
class PlgSampledataJvp extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onAjaxSampledataApplyStep1()
    {
        ...
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP1_SUCCESS');
    ...
    public function onAjaxSampledataApplyStep2()
    {
        ...
        $response            = [];
        $response['success'] = true;
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP2_SUCCESS');
    ...
    public function onAjaxSampledataApplyStep3()
    {
        ...
        $response            = [];
        $response['success'] = true;
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP3_SUCCESS');
    ...
    public function onAjaxSampledataApplyStep4()
    {
        ...
        $response            = [];
        $response['success'] = true;
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP4_SUCCESS');
    ...
    public function onAjaxSampledataApplyStep5()
    {
        ...
        $response            = [];
        $response['success'] = true;
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP5_SUCCESS');
    ...
    public function onAjaxSampledataApplyStep6()
    {
        ...
        $response            = [];
        $response['success'] = true;
        $response['message'] = Text::_('PLG_SAMPLEDATA_JVP_STEP6_SUCCESS');
